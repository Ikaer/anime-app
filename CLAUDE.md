...
- `animes_anilist_tags.json` — AniList catalog metadata (tags + staff + banner) keyed by MAL id (see "AniList tags + staff integration"). The filename says "tags" for historical reasons; the code calls it `anilistMeta`.
