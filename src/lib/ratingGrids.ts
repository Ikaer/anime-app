...
export interface CriterionStep {
  value: number;
  label: string;
  /** Optional longer explanation shown under the label (empty for now). */
  description?: string;
}
...
// 10 critères notés de 0 à 4. Échelle : 0 raté · 1 faible · 2 correct ·
// 3 solide · 4 exceptionnel. Max 40 pts → 10/10 (chaque point = 0.25).
