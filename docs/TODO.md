# SIMKL integration — TODO

- [X] Branch SIMKL API (auth + client alongside the existing MAL integration)
- [X] Add Simkl link in addition to mal link if possible
- [X] Check if we can enrich animes with the tags from SIMKL to have better recommendations
